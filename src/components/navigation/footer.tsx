        ...
        <footer className=" bg-faded-black items-center relative pt-16 pb-4">
            ...
            <div className='flex flex-col gap-4 items-start text-white/80 col-span-2 col-start-4'>
                ...
                <div className='flex flex-col gap-2 '>
                    <a href='' className='flex items-center gap-2 leading-none '><Linkedin/> Linkedin</a>
                    <a href='' className='flex items-center gap-2 leading-none '><Facebook/>Facebook</a>
                    <a href='' className='flex items-center gap-2 leading-none '><Instagram/> Instagram</a>
                    </div>
                </div>
