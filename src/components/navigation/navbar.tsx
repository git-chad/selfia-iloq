  ...
  return (
    <header className="z-50 fixed top-2 left-0 w-full animate-fade-in">
        <Container className="w-full h-full bg-white py-2 backdrop-blur-3xl border-2 border-slate-100/90 rounded-xl flex items-center justify-between">
            <a href="#" className="pl-3 text-2xl font-semibold tracking-tighter">Selfia</a>
            ...
            <a href="#contact" className="mr-3 text-faded-white bg-faded-black px-4 py-1 rounded-lg text-sm">Contacto</a>
        </Container>
    </header>
  )
}
