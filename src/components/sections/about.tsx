    ...
    return (
        <section className="grid grid-cols-12 gap-5 py-32 min-h-svh">
            <div className="col-start-4 col-span-6 text-center place-content-center space-y-2">
                <div className="flex w-max items-center bg-radial-custom rounded-full py-2 px-4 shadow-md border-white space-x-2 col-span-2 mx-auto mb-6">
                    <Brain />
                    <span className="text-black font-medium">Trade experts</span>
                </div>
            ...
            <div className="col-span-12 flex justify-center space-x-5 mt-5">
                <button className="bg-green-500 ">Contactanos</button>
            </div>
