    ...
    return (
        <section id="about" className="relative grid md:grid-cols-12 md:gap-5 py-32 md:min-h-svh">
            <div className="md:col-start-4 md:col-span-6 text-center md:place-content-center space-y-2">
                ...
                <p className="md:text-lg text-lg">En Sevilla, expandimos nuestro mercado y nos hicimos partners oficiales de iLOQ. Contamos con 20 años de experiencia en el rubro y etc.</p>
            </div>
